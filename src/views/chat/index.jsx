...
const Chat = ({ socket }) => {
  ...
  //       axios.get(`http://localhost:4000/v1/admin/${id}`).then((res) => {
  //         const user = res.data.data;
  //         setUser(user);
  //       });
  //     }
  ...
  //     } else if (localStorage.seller) {
  //       axios
  //         .get(`http://localhost:4000/v1/admin`)
  //         .then((res) => {
  //           console.log(res);
  //           const data = res.data.data;
  //           setContacts(data);
  ...
  //           role === "user" ? contact.id : role === "admin" ? contact.id : ""
  //         }`,
  //         {
