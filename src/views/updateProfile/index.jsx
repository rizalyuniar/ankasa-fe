...
const Profile = () => {
  ...
  const onUpdateusers = (e) => {
    ...
    axios
      .put(
        `${process.env.REACT_APP_BACKEND_URL}/user/edit/${profile.id}`,
        formDatas,
        {
          headers: {
                    ...
                    <div className="row">
                      ...
                      >
                        ...
                        <div className={styles.cardProfile}>
                          <div
                            className={`d-flex flex-row justify-content-center  px-5 ${styles.picProfile}`}
                          >
                            <img
                              width={120}
                              height={120}
                          ...
                          <div
                            className={`d-flex flex-row mx-3 ${styles.setProfile}`}
                          >
                            <img
                              src={iconprofile}
                            ...
                            >
                              <p className={`mx-5 ${styles.textProfile}`}>
                                {" "}
                                Profile{" "}
                              </p>
                            </Link>
                          ...
                          <div
                            className={`d-flex flex-row mx-3 ${styles.setMyreview}`}
                          >
                            <img src={iconstar} className={styles.iconstar} />
                            <p className={`mx-5 ${styles.textMyreview}`}>
                              {" "}
                              My Review{" "}
                            </p>
                          </div>
                          <div
                            className={`d-flex flex-row mx-3 ${styles.setSettings}`}
                          >
                            <img
                              src={iconsettings}
