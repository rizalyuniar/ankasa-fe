        ...
        <div className="container">
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className={`navbar-nav mx-auto ${style.navbarNav}`}>
              <form
                className="d-flex my-3 mx-lg-4 mx-md-0 mx-sm-0 position-relative"
                role="search"
              >
                <i className={`${style.iconSearch} bi bi-search`} />
                <input
                  className={`${style.formControl} me-2`}
                  type="search"
...
>>>>>>> 7ea14f19ab94e252015f6b81bccc246a2b906b62
            ...
            {!login ? (
              ...
              <>
                <Link
                  to="/chat"
                  className={`nav-item mx-lg-2 mx-md-0 mx-sm-0 me-sm-4 me-md-4 ${style.navLinkIcon}`}
                >
                ...
                <button
                  type="button"
                  className={`nav-item mx-lg-5 mx-md-0 mx-sm-0 me-sm-4 ${style.navLinkIcon}`}
                  data-bs-toggle="modal"
                ...
                <div className="dropdown">
                  <button
                    className={`${style.buttonProfile} btn btn-secondary`}
                    type="button"
...
>>>>>>> 7ea14f19ab94e252015f6b81bccc246a2b906b62
      ...
      <div
        ...
        id="findTicket"
        tabIndex={-1}
        aria-labelledby="findTicketLabel"
        aria-hidden="true"
      >
          ...
          <div className="modal-content p-3">
            <div className="modal-body">
              <form>
                  ...
                  {!toggle ? (
                    <>
                      <div className={`${style.wrapperDestination}`}>
                        <input
                          type="text"
                          className={style.fromDestination}
                          placeholder=""
                          value="Jakarta"
                        />
                ...
                <input type="date" className={style.formDate} />
                ...
                <div className="container">
                  <div className="row">
                    <p className={`p-0 ${style.subTitle}`}>
                    ...
                    <div className="wrapper d-flex justify-content-between">
                      <div className="form-check form-check-inline">
                        ...
                        />
                        <label
                          className={`form-check-label ${style.formCheckLabel}`}
                          htmlFor="economy"
                        >
                          Economy
                        </label>
                ...
                <button className={style.searchFlight}>
                  SEARCH FLIGHT
            ...
            <div className="modal-body">
              <form>
                ...
                <CardNotif
                  ...
                  message="Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit optio eligendi deserunt et ipsam culpa explicabo, fuga dicta dignissimos nobis?"
                  time="2h"
                />
                <CardNotif
                  title="Ticket Booked"
                  message="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore...."
                  time="1 June 2020, 12:33 AM"
                />
              </form>
            </div>
          </div>
