                ...
                <div className="container p-0">
                  <div className="row">
                    ...
                    <div className="col-md-6 ">
                      <input type="number" className={style.formCek} placeholder="Child" />
                    </div>

                    <div className="col-md-6 ">
                      <input type="number" className={style.formCek} placeholder="Adult" />
                    </div>
                  </div>
                </div>
                  ...
                  <div className="row">
                    ...
                    <div className="wrapper d-flex justify-content-between">
                      <div className="form-check form-check-inline">
                        <input className="form-check-input" type="radio" name="inlineRadioOptions" id="economy" defaultValue="option1" />
                      ...
                      <div className="form-check form-check-inline">
                        <input className="form-check-input" type="radio" name="inlineRadioOptions" id="Business" defaultValue="option2" />
                      ...
                      <div className="form-check form-check-inline">
                        <input className="form-check-input" type="radio" name="inlineRadioOptions" id="FirstClass" defaultValue="option2" />
